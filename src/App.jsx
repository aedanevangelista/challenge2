...
function App() {
  return (
    <div className="min-h-screen bg-[#f3eae3] flex">
      <main className=" w-4/6 md:w-1/2 lg:w-1/2 xl:w-3/6 2xl:w-1/3 m-auto flex lg:flex-row flex-col bg-white rounded-xl">
        ...
        <aside className="flex flex-col lg:w-1/2 p-6 justify-evenly">
          ...
          <p className="my-2 text-gray-600 xl:text-base lg:text-sm w-5/6">
            A floral, solar and voluptuous interpretation composed by Olivier
            Polge, Perfumer-creator for the house of CHANEL
          </p>

          <div className="flex flex-row justify-evenly items-center lg:w-10/12">
